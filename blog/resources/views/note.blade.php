...
<div class="left" id="riji">
    <div class="weizi">
        <div class="wz_text">当前位置：<a href="{{url('index')}}">首页</a>><h1>个人日记</h1></div>
    </div>
    <div class="rj_content">
        <!--时光-->
        <div class="shiguang animated bounceIn">
            <div class="left sg_ico">
                <img src="{{asset('static/images/my_1.jpg')}}" width="120" height="120" alt=""/>
            </div>
            <div class="right sg_text">
                <img src="{{asset('static/images/left.png')}}" width="13" height="16" alt="左图标"/>
